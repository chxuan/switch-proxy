...
/* #include "public/utility/config_file.h" */
#include "../tcp/tcp_switch_session_manager.h"
#include "../udp/udp_switch_session_manager.h"

void switch_proxy::run()
{
    /* std::string listen_ip = singletion<config_file>::getinstance()->get_string("listen_ip"); */
    /* int listen_port = singletion<config_file>::getinstance()->get_int("listen_port"); */
    /* address listen_address(listen_ip, listen_port); */

    /* std::vector<address> target_address_list = read_target_address(); */

    /* int io_threads = singletion<config_file>::getinstance()->get_int("io_threads"); */

    /* std::string type = singletion<config_file>::getinstance()->get_string("type"); */
    /* if (type == "tcp") */
    /* { */
...
std::vector<address> switch_proxy::read_target_address()
{
    ...
    /*     if (singletion<config_file>::getinstance()->is_exist(ip_key) && singletion<config_file>::getinstance()->is_exist(port_key)) */
    /*     { */
    /*         std::string ip = singletion<config_file>::getinstance()->get_string(ip_key); */
    /*         int port = singletion<config_file>::getinstance()->get_int(port_key); */
